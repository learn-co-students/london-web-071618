...
class App extends Component {
  ...
  searchedShows = () => {
    return this.displayShows()
      .filter(show => show.name.toLowerCase().includes(this.state.searchTerm.toLowerCase()))
  }
      ...
      <div>
        ...
        <Grid celled>
          ...
          <Grid.Column width={11}>
            <TVShowList shows={this.searchedShows()} selectShow={this.selectShow} searchTerm={this.state.searchTerm}/>
          </Grid.Column>
        </Grid>
      </div>
    );
